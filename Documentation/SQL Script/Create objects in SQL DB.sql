...
BEGIN
    EXEC('CREATE PROCEDURE [Helper].[LoadTransferObject]
          ...
          BEGIN
              ...
              UNION ALL  SELECT ''GOOG''    AS SourceObjectName, NULL AS Batch, ''Daily'' AS LoadMode, ''YahooFinance'' AS Api, NULL AS WatermarkEH, ''Dow Jones'' AS Stockmarket, 0 AS Enabled
              ...
              UNION ALL  SELECT ''AAPL''    AS SourceObjectName, NULL AS Batch, ''Daily'' AS LoadMode, ''YahooFinance'' AS Api, NULL AS WatermarkEH, ''Dow Jones'' AS Stockmarket, 0 AS Enabled
